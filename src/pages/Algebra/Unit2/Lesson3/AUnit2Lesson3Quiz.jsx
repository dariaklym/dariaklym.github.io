...
import "./AUnit2Lesson3Quiz.css";
import { AUnit2Lesson3Questions } from "./AUnit2Lesson3QuizData";

export default function AUnit2Lesson3Quiz({ setCurrentPage }) {
