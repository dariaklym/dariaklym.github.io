...
import "./AUnit1Lesson1Quiz.css";
import { AUnit1Lesson1Questions } from "./AUnit1Lesson1QuizData";

export default function AUnit1Lesson1Quiz({ setCurrentPage }) {
