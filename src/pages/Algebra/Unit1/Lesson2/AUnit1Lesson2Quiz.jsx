...
import "./AUnit1Lesson2Quiz.css";
import { AUnit1Lesson2Questions } from "./AUnit1Lesson2QuizData";

export default function AUnit1Lesson2Quiz({ setCurrentPage }) {
