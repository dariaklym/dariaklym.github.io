...
import "./SUnit2Lesson2Quiz.css";
import { SUnit2Lesson2Questions } from "./SUnit2Lesson2QuizData";

export default function SUnit2Lesson2Quiz({ setCurrentPage }) {
