...
import "./SUnit2Lesson3Quiz.css";
import { SUnit2Lesson3Questions } from "./SUnit2Lesson3QuizData";

export default function SUnit2Lesson3Quiz({ setCurrentPage }) {
