...
import "./SUnit5Lesson3Quiz.css";
import { SUnit5Lesson3Questions } from "./SUnit5Lesson3QuizData";

export default function SUnit5Lesson3Quiz({ setCurrentPage }) {
