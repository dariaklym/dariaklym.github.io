...
import "./SUnit5Lesson1Quiz.css";
import { SUnit5Lesson1Questions } from "./SUnit5Lesson1QuizData";

export default function SUnit5Lesson1Quiz({ setCurrentPage }) {
