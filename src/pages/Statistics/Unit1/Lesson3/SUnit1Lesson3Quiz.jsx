...
import "./SUnit1Lesson3Quiz.css";
import { SUnit1Lesson3Questions } from "./SUnit1Lesson3QuizData";

export default function SUnit1Lesson3Quiz({ setCurrentPage }) {
