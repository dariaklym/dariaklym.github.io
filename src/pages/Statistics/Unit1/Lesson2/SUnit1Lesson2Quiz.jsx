...
import "./SUnit1Lesson2Quiz.css";
import { SUnit1Lesson2Questions } from "./SUnit1Lesson2QuizData";

export default function SUnit1Lesson2Quiz({ setCurrentPage }) {
