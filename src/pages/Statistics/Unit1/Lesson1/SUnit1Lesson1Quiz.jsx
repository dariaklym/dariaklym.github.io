...
import "./SUnit1Lesson1Quiz.css";
import { SUnit1Lesson1Questions } from "./SUnit1Lesson1QuizData";

export default function SUnit1Lesson1Quiz({ setCurrentPage }) {
