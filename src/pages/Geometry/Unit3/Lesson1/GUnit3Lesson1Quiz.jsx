...
import "./GUnit3Lesson1Quiz.css";
import { GUnit3Lesson1Questions } from "./GUnit3Lesson1QuizData";

export default function GUnit3Lesson1Quiz({ setCurrentPage }) {
