...
import "./GUnit3Lesson3Quiz.css";
import { GUnit3Lesson3Questions } from "./GUnit3Lesson3QuizData";

export default function GUnit3Lesson3Quiz({ setCurrentPage }) {
