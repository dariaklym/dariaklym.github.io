...
import "./GUnit3Lesson4Quiz.css";
import { GUnit3Lesson4Questions } from "./GUnit3Lesson4QuizData";

export default function GUnit3Lesson4Quiz({ setCurrentPage }) {
