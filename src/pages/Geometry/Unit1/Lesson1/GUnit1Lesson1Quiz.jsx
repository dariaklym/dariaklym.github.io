...
import "./GUnit1Lesson1Quiz.css";
import { GUnit1Lesson1Questions } from "./GUnit1Lesson1QuizData";

export default function GUnit1Lesson1Quiz({ setCurrentPage }) {
