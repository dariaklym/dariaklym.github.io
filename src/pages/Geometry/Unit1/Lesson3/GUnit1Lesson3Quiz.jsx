...
import "./GUnit1Lesson3Quiz.css";
import { GUnit1Lesson3Questions } from "./GUnit1Lesson3QuizData";

export default function GUnit1Lesson3Quiz({ setCurrentPage }) {
