...
import "./GUnit1Lesson4Quiz.css";
import { GUnit1Lesson4Questions } from "./GUnit1Lesson4QuizData";

export default function GUnit1Lesson4Quiz({ setCurrentPage }) {
