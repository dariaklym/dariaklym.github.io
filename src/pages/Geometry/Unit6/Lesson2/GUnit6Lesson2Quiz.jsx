...
import "./GUnit6Lesson2Quiz.css";
import { GUnit6Lesson2Questions } from "./GUnit6Lesson2QuizData";

export default function GUnit6Lesson2Quiz({ setCurrentPage }) {
