...
import "./GUnit6Lesson3Quiz.css";
import { GUnit6Lesson3Questions } from "./GUnit6Lesson3QuizData";

export default function GUnit6Lesson3Quiz({ setCurrentPage }) {
