...
import "./GUnit6Lesson1Quiz.css";
import { GUnit6Lesson1Questions } from "./GUnit6Lesson1QuizData";

export default function GUnit6Lesson1Quiz({ setCurrentPage }) {
