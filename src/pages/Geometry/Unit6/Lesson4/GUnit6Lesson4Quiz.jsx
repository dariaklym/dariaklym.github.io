...
import "./GUnit6Lesson4Quiz.css";
import { GUnit6Lesson4Questions } from "./GUnit6Lesson4QuizData";

export default function GUnit6Lesson4Quiz({ setCurrentPage }) {
