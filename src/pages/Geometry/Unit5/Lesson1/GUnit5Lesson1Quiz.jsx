...
import "./GUnit5Lesson1Quiz.css";
import { GUnit5Lesson1Questions } from "./GUnit5Lesson1QuizData";

export default function GUnit5Lesson1Quiz({ setCurrentPage }) {
