...
import "./GUnit5Lesson2Quiz.css";
import { GUnit5Lesson2Questions } from "./GUnit5Lesson2QuizData";

export default function GUnit5Lesson2Quiz({ setCurrentPage }) {
