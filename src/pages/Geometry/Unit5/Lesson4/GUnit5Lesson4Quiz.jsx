...
import "./GUnit5Lesson4Quiz.css";
import { GUnit5Lesson4Questions } from "./GUnit5Lesson4QuizData";

export default function GUnit5Lesson4Quiz({ setCurrentPage }) {
