...
import "./GUnit2Lesson1Quiz.css";
import { GUnit2Lesson1Questions } from "./GUnit2Lesson1QuizData";

export default function GUnit2Lesson1Quiz({ setCurrentPage }) {
