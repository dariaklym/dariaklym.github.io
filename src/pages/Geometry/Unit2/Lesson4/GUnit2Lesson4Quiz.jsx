...
import "./GUnit2Lesson4Quiz.css";
import { GUnit2Lesson4Questions } from "./GUnit2Lesson4QuizData";

export default function GUnit2Lesson4Quiz({ setCurrentPage }) {
