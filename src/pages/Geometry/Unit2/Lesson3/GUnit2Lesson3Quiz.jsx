...
import "./GUnit2Lesson3Quiz.css";
import { GUnit2Lesson3Questions } from "./GUnit2Lesson3QuizData";

export default function GUnit2Lesson3Quiz({ setCurrentPage }) {
