...
import "./GUnit2Lesson2Quiz.css";
import { GUnit2Lesson2Questions } from "./GUnit2Lesson2QuizData";

export default function GUnit2Lesson2Quiz({ setCurrentPage }) {
