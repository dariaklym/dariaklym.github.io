...
import "./GUnit4Lesson2Quiz.css";
import { GUnit4Lesson2Questions } from "./GUnit4Lesson2QuizData";

export default function GUnit4Lesson2Quiz({ setCurrentPage }) {
