...
import "./GUnit4Lesson3Quiz.css";
import { GUnit4Lesson3Questions } from "./GUnit4Lesson3QuizData";

export default function GUnit4Lesson3Quiz({ setCurrentPage }) {
