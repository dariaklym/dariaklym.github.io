...
import "./GUnit4Lesson1Quiz.css";
import { GUnit4Lesson1Questions } from "./GUnit4Lesson1QuizData";

export default function GUnit4Lesson1Quiz({ setCurrentPage }) {
