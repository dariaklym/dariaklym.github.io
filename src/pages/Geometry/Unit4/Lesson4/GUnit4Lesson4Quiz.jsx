...
import "./GUnit4Lesson4Quiz.css";
import { GUnit4Lesson4Questions } from "./GUnit4Lesson4QuizData";

export default function GUnit4Lesson4Quiz({ setCurrentPage }) {
