...
import "./PAUnit5Lesson2Quiz.css";
import { PAUnit5Lesson2Questions } from "./PAUnit5Lesson2QuizData";

export default function PAUnit5Lesson2Quiz({ setCurrentPage }) {
