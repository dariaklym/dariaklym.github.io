...
import "./PAUnit5Lesson3Quiz.css";
import { PAUnit5Lesson3Questions } from "./PAUnit5Lesson3QuizData";

export default function PAUnit5Lesson3Quiz({ setCurrentPage }) {
