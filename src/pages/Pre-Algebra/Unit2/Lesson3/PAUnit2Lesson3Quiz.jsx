...
import "./PAUnit2Lesson3Quiz.css";
import { PAUnit2Lesson3Questions } from "./PAUnit2Lesson3QuizData";

export default function PAUnit2Lesson3Quiz({ setCurrentPage }) {
