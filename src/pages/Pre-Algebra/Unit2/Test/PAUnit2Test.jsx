...
import "./PAUnit2Test.css";
import { PAUnit2TestQuestions } from "./PAUnit2TestData";

export default function PAUnit2Test({ setCurrentPage }) {
  ...
  return (
    <div className="test-container">
      <h1 className="test-title">Unit 2 Test</h1>

      {PAUnit2TestQuestions.map((q) => (
