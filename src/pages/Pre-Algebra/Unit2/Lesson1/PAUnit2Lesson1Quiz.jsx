...
import "./PAUnit2Lesson1Quiz.css";
import { PAUnit2Lesson1Questions } from "./PAUnit2Lesson1QuizData";

export default function PAUnit2Lesson1Quiz({ setCurrentPage }) {
