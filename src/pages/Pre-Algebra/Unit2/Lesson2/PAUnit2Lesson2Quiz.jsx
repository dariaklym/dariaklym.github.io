...
import "./PAUnit2Lesson2Quiz.css";
import { PAUnit2Lesson2Questions } from "./PAUnit2Lesson2QuizData";

export default function PAUnit2Lesson2Quiz({ setCurrentPage }) {
