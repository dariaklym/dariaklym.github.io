...
import "./PAUnit4Lesson3Quiz.css";
import { PAUnit4Lesson3Questions } from "./PAUnit4Lesson3QuizData";

export default function PAUnit4Lesson3Quiz({ setCurrentPage }) {
