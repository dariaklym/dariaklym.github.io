...
import "./PAUnit6Lesson2Quiz.css";
import { PAUnit6Lesson2Questions } from "./PAUnit6Lesson2QuizData";

export default function PAUnit6Lesson2Quiz({ setCurrentPage }) {
