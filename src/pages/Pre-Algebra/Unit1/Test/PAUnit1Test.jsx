...
import "./PAUnit1Test.css";
import { PAUnit1TestQuestions } from "./PAUnit1TestData";

export default function PAUnit1Test({ setCurrentPage }) {
  ...
  return (
    <div className="test-container">
      <h1 className="test-title">Unit 1 Test</h1>

      {PAUnit1TestQuestions.map((q) => (
