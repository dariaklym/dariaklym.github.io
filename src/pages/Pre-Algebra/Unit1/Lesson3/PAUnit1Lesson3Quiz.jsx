...
import "./PAUnit1Lesson3Quiz.css";
import { PAUnit1Lesson3Questions } from "./PAUnit1Lesson3QuizData";

export default function PAUnit1Lesson3Quiz({ setCurrentPage }) {
