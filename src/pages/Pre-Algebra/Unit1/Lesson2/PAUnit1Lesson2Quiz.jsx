...
import "./PAUnit1Lesson2Quiz.css";
import { PAUnit1Lesson2Questions } from "./PAUnit1Lesson2QuizData";

export default function PAUnit1Lesson2Quiz({ setCurrentPage }) {
