...
import "./PAUnit3Lesson3Quiz.css";
import { PAUnit3Lesson3Questions } from "./PAUnit3Lesson3QuizData";

export default function PAUnit3Lesson3Quiz({ setCurrentPage }) {
