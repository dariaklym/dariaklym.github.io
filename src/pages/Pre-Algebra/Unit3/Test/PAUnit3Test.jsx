...
import "./PAUnit3Test.css";
import { PAUnit3TestQuestions } from "./PAUnit3TestData";

export default function PAUnit3Test({ setCurrentPage }) {
  ...
  return (
    <div className="test-container">
      <h1 className="test-title">Unit 3 Test</h1>

      {PAUnit3TestQuestions.map((q) => (
