...
import "./PAUnit3Lesson1Quiz.css";
import { PAUnit3Lesson1Questions } from "./PAUnit3Lesson1QuizData";

export default function PAUnit3Lesson1Quiz({ setCurrentPage }) {
